...
public class TestMetier {
	...
	public static void testCrediterDebiterJoueur () {
		...
		try{
	         ...
	         siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 1780, new String("ilesCaimans"));
	         siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Francoise"), new String("fanfan"), 1917, new String("ilesCaimans"));
	         siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Morgane"), new String("momo"), 1848, new String("ilesCaimans"));
	         ...
	         //credit  incorrect
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Maradonab"),new String("Diegob"),new String("world3Champ"),1500, null);
	            System.out.println("cr�diter un joueur avec un password gestionnaire  invalide (non instanci�) n'a pas lev� l'exception MetierException");
	         }
	         catch (MetierException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec un password gestionnaire  invalide (non instanci�) n'a pas lev� l'exception MetierException mais " + e.getClass().getName());
	         }
	      
	         try {
	            siteDeParisMetier.crediterJoueur(new String("finaleRG2012"),new String("Tsonga"),new String("raphael"),1521, "ilesCimans");
	            System.out.println(" crediter un joueur avec un password gestionnaire incorrect sans lever MetierException");
	         }
	         catch (MetierException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec un password gestionnaire incorrect sans lever MetierException mais " + e.getClass().getName());
	         }
	         //exception metierexception a lever si somme en jetons n�gative
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Maradonab"),new String("Diegob"),new String("world3Champ"),-1, "ilesCaimans");
	            System.out.println("cr�diter un joueur avec une somme n�gative n'a pas lev� MetierException");
	         }
	         catch (MetierException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec une somme n�gative n'a pas lev� MetierException mais " + e.getClass().getName());
	         }
	         
	         //joueurexception
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Maradonab254"),new String("Diegob"),new String("world3Champ"),1254, "ilesCaimans");
	            System.out.println("cr�diter un joueur avec un nom invalide n'a pas lev� JoueurException");
	         }
	         catch (JoueurException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec un nom invalide n'a pas lev� JoueurException mais " + e.getClass().getName());
	         }
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Maradonab"),new String("Diegob26"),new String("world3Champ"),1, "ilesCaimans");
	            System.out.println("cr�diter un joueur avec un pr�nom invalide n'a pas lev� JoueurException");
	         }
	         catch (JoueurException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec pr�nom invalide n'a pas lev� JoueurException mais " + e.getClass().getName());
	         }
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Maradonab"),new String("Diegob"),new String("world_3Champ"),12, "ilesCaimans");
	            System.out.println("cr�diter un joueur avec un pseudo invalide n'a pas lev� JoueurException");
	         }
	         catch (JoueurException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec un pseudo invalide n'a pas lev� JoueurException mais " + e.getClass().getName());
	         }
	         
	         //JoueurInexistantException
	         
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Ali"),new String("Delphine"),new String("world3Champ"),12, "ilesCaimans");
	            System.out.println("cr�diter un joueur avec un nom/prenom/pseudo inexistant n'a pas lev� JoueurInexistantException");
	         }
	         catch (JoueurInexistantException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec un nom/prenom/pseudo inexistant n'a pas lev� JoueurInexistantException mais " + e.getClass().getName());
	         }
	         try {
	            siteDeParisMetier.crediterJoueur(new String("Prou"),new String("Bernard"),new String("nanar"),12, "ilesCaimans");
	            System.out.println("cr�diter un joueur avec un pseudo inexistant n'a pas lev� JoueurInexistantException");
	         }
	         catch (JoueurInexistantException e) { }
	         catch (Exception e) { 
	            System.out.println("cr�diter un joueur avec un pseudo inexistant n'a pas lev� JoueurInexistantException mais " + e.getClass().getName());
	         }
	      
	      //d�bit  incorrect
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Maradonab"),new String("Diegob"),new String("world3Champ"),1500, null);
	         ...
	         try {
	            siteDeParisMetier.debiterJoueur(new String("finaleRG2012"),new String("Tsonga"),new String("raphael"),1521, "ilesCimans");
	            System.out.println(" debiter un joueur avec un password gestionnaire incorrect sans lever MetierException");
	         }
	         catch (MetierException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec un password gestionnaire incorrect sans lever MetierException mais " + e.getClass().getName());
	         }
	         //exception metierexception a lever si somme en jetons n�gative
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Maradonab"),new String("Diegob"),new String("world3Champ"),-1, "ilesCaimans");
	            System.out.println("debiter un joueur avec une somme n�gative n'a pas lev� MetierException");
	         }
	         catch (MetierException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec une somme n�gative n'a pas lev� MetierException mais " + e.getClass().getName());
	         }
	         
	         //joueurexception
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Maradonab254"),new String("Diegob"),new String("world3Champ"),1254, "ilesCaimans");
	            System.out.println("debiter un joueur avec un nom invalide n'a pas lev� JoueurException");
	         }
	         catch (JoueurException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec un nom invalide n'a pas lev� JoueurException mais " + e.getClass().getName());
	         }
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Maradonab"),new String("Diegob26"),new String("world3Champ"),1, "ilesCaimans");
	            System.out.println("debiter un joueur avec un pr�nom invalide n'a pas lev� JoueurException");
	         }
	         catch (JoueurException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec pr�nom invalide n'a pas lev� JoueurException mais " + e.getClass().getName());
	         }
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Maradonab"),new String("Diegob"),new String("world_3Champ"),12, "ilesCaimans");
	            System.out.println("debiter un joueur avec un pseudo invalide n'a pas lev� JoueurException");
	         }
	         catch (JoueurException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec un pseudo invalide n'a pas lev� JoueurException mais " + e.getClass().getName());
	         }
	         
	         //debiter un joueur de plus que son solde prou a 785 je lui enleve 800
	         try{
	            siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Aureliane"), new String("aure"), 800, new String("ilesCaimans"));
	            System.out.println("d�biter un joueur de plus que son solde n'a pas lev� JoueurException");
	            }
	            catch(JoueurException e){}
	            catch(Exception e){
	               System.out.println("d�biter un joueur de plus que son solde n'a pas lev� JoueurException mais "+e.getClass().getName());
	            }
	            
	         //JoueurInexistantException
	         
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Ali"),new String("Delphine"),new String("world3Champ"),12, "ilesCaimans");
	            System.out.println("debiter un joueur avec un nom/prenom/pseudo inexistant n'a pas lev� JoueurInexistantException");
	         }
	         catch (JoueurInexistantException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec un nom/prenom/pseudo inexistant n'a pas lev� JoueurInexistantException mais " + e.getClass().getName());
	         }
	         try {
	            siteDeParisMetier.debiterJoueur(new String("Prou"),new String("Bernard"),new String("nanar"),12, "ilesCaimans");
	            System.out.println("debiter un joueur avec un pseudo inexistant n'a pas lev� JoueurInexistantException");
	         }
	         catch (JoueurInexistantException e) { }
	         catch (Exception e) { 
	            System.out.println("debiter un joueur avec un pseudo inexistant n'a pas lev� JoueurInexistantException mais " + e.getClass().getName());
	         }
